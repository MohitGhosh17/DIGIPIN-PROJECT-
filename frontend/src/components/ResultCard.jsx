const ResultCard = ({ digipin, latitude, longitude }) => {
  ...
  return (
    <div className="absolute bottom-6 right-6 z-10 bg-white bg-opacity-90 backdrop-blur-md shadow-lg rounded-xl p-6 w-[350px] border-2 border-black rounded-lg ">
